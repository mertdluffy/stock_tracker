<x-layout>
    ...
    <div class="container py-8 max-w-4xl mx-auto border-gray-200 d-flex justify-content-between">
        ...
        <form method="POST" action="{{url(app()->getLocale().'/category')}}" enctype="multipart/form-data">
        ...
        <form method="GET" action="{{url(app()->getLocale().'/items/create')}}" enctype="multipart/form-data">
            @csrf
